...
return [
    ...
    'storage' => [
        ...
        'database' => [
            ...
            'database' => config('database.connections.mysql.database', env('DB_DATABASE', 'forge')),
            'username' => config('database.connections.mysql.username', env('DB_USERNAME', 'forge')),
