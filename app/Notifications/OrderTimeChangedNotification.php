...
class OrderTimeChangedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage())
            ...
            ->line(trans('Order #:orderNumber time has been changed.', [
                'orderNumber' => $this->order->id,
            ]))
    ...
    {
        return trans('Order #:orderId (:serviceName) time has been changed. Date: :date', [
